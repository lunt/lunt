...
namespace Lunt.Tests.Unit
{
    public class BuildConfigurationXmlReaderTests
    {
        ...
        public class TheReadMethod
        {
            ...
            {
                // Given, When
                var result = Record.Exception(() => BuildConfigurationReader.Read((XDocument)null));
            ...
            public void XML_Must_Contain_Build_Element()
            {
                ...
                // When
                var result = Record.Exception(() => BuildConfigurationReader.Read(document));
            ...
            public void Build_Element_Is_Case_Insensitive()
            {
                ...
                // When
                var result = BuildConfigurationReader.Read(document);
